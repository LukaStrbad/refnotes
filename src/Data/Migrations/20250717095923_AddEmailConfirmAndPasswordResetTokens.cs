...
{
    /// <inheritdoc />
    public partial class AddEmailConfirmAndPasswordResetTokens : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_email_confirm_tokens_users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_email_confirm_tokens_UserId",
                table: "email_confirm_tokens",
                column: "UserId");

            migrationBuilder.CreateIndex(
                name: "IX_email_confirm_tokens_Value",
                table: "email_confirm_tokens",
                column: "Value");
